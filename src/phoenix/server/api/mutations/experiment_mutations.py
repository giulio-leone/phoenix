...
class ExperimentMutationMixin:
    ...
    async def delete_experiments(
        ...
        # Stop any running experiments before deleting to cancel in-flight jobs
        # and avoid FK constraint violations from concurrent writes.
        for exp_id in experiment_ids:
            info.context.experiment_runner.stop_experiment(exp_id)
